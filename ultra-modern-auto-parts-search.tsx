...
import { popularParts, searchResults, brands } from "@/lib/data"
          ...
          <section className="relative z-10 pt-32 pb-16">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-3">Premium Auto Brands</h2>
                <p className="text-white/60">Quality parts from the world's leading automotive manufacturers</p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
                {brands.map((brand) => (
                  <Link key={brand.id} href={`/brand/${brand.id}`} className="group flex flex-col items-center">
                    <div className="w-24 h-24 rounded-2xl bg-white p-4 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl group-hover:shadow-blue-500/20">
                      <Image
                ...
                <div className="relative group">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder={searchFocused ? "" : "Enter part name or article number"}
                    ...
                    {searchFocused && searchQuery === "" && (
                      <div className="absolute left-16 top-1/2 transform -translate-y-1/2 text-white/50 pointer-events-none">
                        <AnimatedPlaceholder
                          texts={["Brembo brake pads", "Mann oil filter", "Bosch 60Ah battery", "NGK spark plugs"]}
                        />
                      </div>
                    )}
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {searchResults.map((result) => (
                    <Link href={`/product/${result.id}`} key={result.id} className="block">
                      <div
                        className={cn(
                      ...
                      >
                        ...
                        <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                          ...
                          <Button size="sm" className="rounded-full bg-white/10 hover:bg-blue-600 transition-colors">
                            Add to cart
                          </Button>
                        </div>
                      </div>
